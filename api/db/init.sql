...
VALUES ('Dr. Ana Silva', 'ana.silva@email.com', '$2b$12$9vh0QQQBwfstXX36RgsNUejr4M.zMPXTqDjbNjlBxcxd/s/ZHI.Ga',
        'PROFESSIONAL', 'READY', 'CRP/01-12345'),
       ('Dr. Carlos Souza', 'carlos.souza@email.com', '$2b$12$9vh0QQQBwfstXX36RgsNUejr4M.zMPXTqDjbNjlBxcxd/s/ZHI.Ga',
        'PROFESSIONAL', 'READY', 'CRP/02-54321'),
       ('João Pereira', 'joao.p@email.com', '$2b$12$9vh0QQQBwfstXX36RgsNUejr4M.zMPXTqDjbNjlBxcxd/s/ZHI.Ga', 'PATIENT',
        'READY', NULL),
       ('Maria Oliveira', 'maria.o@email.com', '$2b$12$9vh0QQQBwfstXX36RgsNUejr4M.zMPXTqDjbNjlBxcxd/s/ZHI.Ga',
        'PATIENT', 'READY', NULL),
       ('Lorenzo Pandolfo', 'lorenzo.p@email.com', '$2b$12$9vh0QQQBwfstXX36RgsNUejr4M.zMPXTqDjbNjlBxcxd/s/ZHI.Ga',
        'PATIENT', 'READY', NULL),
       ('Beatriz Lima', 'beatriz.l@email.com', '$2b$12$9vh0QQQBwfstXX36RgsNUejr4M.zMPXTqDjbNjlBxcxd/s/ZHI.Ga',
        'PROFESSIONAL', 'WAITING_VALIDATION', 'CRP/03-98765');

-- Insert Availabilities
-- Dr. Ana Silva
INSERT INTO availabilities (owner_id, start_time, end_time)
SELECT id, '2025-09-01 09:00:00+00', '2025-09-01 10:00:00+00'
FROM users
WHERE email = 'ana.silva@email.com';
INSERT INTO availabilities (owner_id, start_time, end_time)
SELECT id, '2025-09-03 09:00:00+00', '2025-09-03 10:00:00+00'
FROM users
WHERE email = 'ana.silva@email.com';

-- Dr. Carlos Souza
INSERT INTO availabilities (owner_id, start_time, end_time)
SELECT id, '2025-09-02 08:00:00+00', '2025-09-02 09:00:00+00'
FROM users
WHERE email = 'carlos.souza@email.com';
INSERT INTO availabilities (owner_id, start_time, end_time)
SELECT id, '2025-09-04 08:00:00+00', '2025-09-04 09:00:00+00'
FROM users
WHERE email = 'carlos.souza@email.com';

-- Beatriz Lima (em validação, não vai ter agendamentos ainda)
INSERT INTO availabilities (owner_id, start_time, end_time)
SELECT id, '2025-09-05 10:00:00+00', '2025-09-05 11:00:00+00'
FROM users
WHERE email = 'beatriz.l@email.com';
