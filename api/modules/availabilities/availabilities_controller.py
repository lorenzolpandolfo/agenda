...
async def availabilities(
    ...
    availability: Availabilities = service.create_availability(data, credentials.subject.get("user_id"))
...
async def availabilities(
    ...
    availability_list: List[Availabilities] = service.get_availabilities(professional_id)
...
async def change_status(
    ...
    availability: Availabilities = service.change_status(data, credentials.subject.get("user_id"))
